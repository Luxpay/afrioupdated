                      ...
                      InkWell(
                        onTap: () => {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const RaiseFunds()))
                        },
                        child: Column(
                          children: [
                            Image.asset(
                      ...
                      InkWell(
                        onTap: () => {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const Crowd365()))
                        },
                        child: Column(
                          children: [
                            Image.asset(
                      ...
                      InkWell(
                        onTap: () => {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const GenericBillPage(
                                        title: "Electricity",
                                        transactionIdHint: "Meter number",
                        ...
                        onTap: () => {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => const GenericBillPage(
                                        title: "TV",
                                        transactionIdHint: "Decoder number",
                                        transactionIdInnerHint:
